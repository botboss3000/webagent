...
The actual system prompts come from app/context/agents/*.json
...
# No hardcoded prompts — they come from app/context/agents/*.json files
ALL_TEMPLATES = []


def seed_optimizer_templates() -> int:
    """Seeds optimizer prompt templates into context_templates.
    Currently no-op since prompts come from app/context/agents/*.json
