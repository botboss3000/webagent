...
from app.api.rate_limit import enforce, client_ip
...
async def browser_chat(request: BrowserChatRequest, fastapi_request: Request):
    ...
    _max = int(os.environ.get("WEBAGENT_BROWSER_CHAT_MAX", "30"))
    _win = int(os.environ.get("WEBAGENT_BROWSER_CHAT_WINDOW", "300"))
    enforce(f"browser:chat:{client_ip(fastapi_request)}", _max, _win,
