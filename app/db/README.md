...
The Database & Devices page (`ui/admin-tools/database-devices/`) reads this in its `/backend-status` and renders a red "Not connected to the shared database" banner with a one-click jump to the sign-in form, instead of the misleading green "Connected".
