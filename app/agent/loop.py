...
async def run_agent_loop(
    ...
    while turn_count < max_turns:
        ...
        if turn_count >= 11 and not permission_granted:
            # Look for permission keywords in the last user message
            ...
            if last_user_msg:
                ...
                if any(keyword in user_content for keyword in permission_keywords):
                    ...
                    # Extend max turns by 10 more when permission is granted
