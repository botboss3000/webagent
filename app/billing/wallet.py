...
Agent-admin wallets are informational mirrors of platform fees & earnings —
real money lives in Stripe Connect / PayPal Marketplace.
"""
...
def _has_tables(db: Any) -> bool:
    from app.billing.pricing import _has_billing_tables
