# `tui-data/` — the Server Manager's human-readable configuration
...
[`../tui_app/resources.py`](../tui_app/resources.py) and bundled into the frozen build by
...
The watchdog ([`../tui_app/watchdog.py`](../tui_app/watchdog.py)) re-reads both **every tick**, so
...
— see [`../tui_app/playbook.py`](../tui_app/playbook.py) (pure logic) and
[`../tui_app/pb_coordinator.py`](../tui_app/pb_coordinator.py) (storage + auto-programming).
