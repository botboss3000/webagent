...
├── launcher/               # Polished Textual TUI launcher; builds to a single portable webAgent.exe (Launch / Restart / Stop / Browser / Clear DB / Reset Python / Full Reset, animated procedural ASCII background with cycleable color presets + rainbow). See launcher/README.md.
