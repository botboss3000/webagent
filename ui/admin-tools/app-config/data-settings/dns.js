...
function _fieldLink(link) {
  ...
  a.style.cssText = 'display:inline-block;margin:2px 0 4px;font-size:12px;color:var(--accent);';
  return a;
}
...
function _tipBadge(tip) {
  ...
  b.textContent = 'ⓘ';
  b.title = text;
  b.style.cssText = 'margin-left:6px;color:var(--fg-3);cursor:help;font-size:12px;';
  return b;
}
