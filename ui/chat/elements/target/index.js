...
// Chat element: target — choose which device runs the next message

export function html(cfg = {}) {
  const size = cfg.element_size || '16px';
  return `<button type="button" class="chat-target-btn" title="Remote Control — choose which device runs your next message" data-element-name="target">
