...
// Chat element: delete_session — delete the current session

export function html(cfg = {}) {
  const size = cfg.element_size || '18px';
  return `<button type="button" class="header-delete-btn" title="Delete session" data-state="trash" data-element-name="delete_session">
