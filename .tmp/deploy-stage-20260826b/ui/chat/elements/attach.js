...
// Chat element: attach — attach files to the current message

export function html(cfg = {}) {
  const size = cfg.element_size || '22px';
  return `<button type="button" class="chat-pill-attach" title="Attach files (or paste / drop onto the chat pill)" data-element-name="attach">
