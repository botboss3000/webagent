...
// Chat element: continue — send 'continue' to resume the agent

export function html(cfg = {}) {
  return `<button type="button" class="chat-continue-btn" title="Send 'continue' to resume the agent" data-element-name="continue">
