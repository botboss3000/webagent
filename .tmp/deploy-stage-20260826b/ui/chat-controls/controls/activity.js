...
// Chat control: activity — tool-call activity chip with expandable panel
...
export function html(cfg = {}) {
  return `<div class="chat-activity-wrapper" style="display:contents">
    ...
    <button type="button" class="chat-activity-bar" data-controls-name="activity" aria-expanded="false" aria-controls="chat-activity-panel" title="Show tool calls from this turn">
