...
// Chat control: refresh — refresh the chat transcript

export function html(cfg = {}) {
  const size = cfg.element_size || '18px';
  return `<button type="button" class="chat-refresh-btn" title="Refresh the chat transcript" data-controls-name="refresh">
