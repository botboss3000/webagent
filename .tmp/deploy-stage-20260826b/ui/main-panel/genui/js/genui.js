...
// The chat sub-header genui chips open a page through this hook — mirrors the
// browser page's window.__switchWebSession pattern (browser.js).
window.__switchGenuiPage = switchToPage;
