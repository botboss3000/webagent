...
change the conversation.  Its only job in phase 1 is to turn one or more user
messages into a durable run-intelligence artifact: objective, constraints,
questions, success criteria, plan, expected outputs, and a title candidate.
